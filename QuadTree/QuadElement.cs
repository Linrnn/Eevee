...
namespace Eevee.QuadTree
{
    ...
    public readonly struct QuadElement : IEquatable<QuadElement>, IComparable<QuadElement>, IFormattable
    {
        ...
        public static bool operator ==(in QuadElement lhs, in QuadElement rhs) => lhs.Index == rhs.Index && lhs.AABB == rhs.AABB;
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator !=(in QuadElement lhs, in QuadElement rhs) => lhs.Index != rhs.Index || lhs.AABB != rhs.AABB;
        #endregion
        ...
        public int CompareTo(QuadElement other)
        {
            ...
            int match1 = AABB.CompareTo(other.AABB);
            if (match1 != 0)
                return match1;
        ...
        public string ToString(string format, IFormatProvider provider) => $"Index:{Index.ToString(format, provider)}, AABB:{AABB.ToString(format, provider)}";
        #endregion
    }
}