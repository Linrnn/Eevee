...
namespace Eevee.QuadTree
{
    public sealed class QuadTreeManager
    {
        ...
        #region 预处理元素
        public bool PreCountElement(int treeId, int index, in Change<Vector2DInt> center, int extent, out QuadPreCache cache)
        {
            if (center.Equals())
            {
                cache = default;
            ...
            var preEle = new QuadElement(index, new AABB2DInt(center.Pre, extent));
            var tarEle = new QuadElement(index, new AABB2DInt(center.Tar, extent));
        ...
        public bool PreCountElement(int treeId, int index, in Change<Vector2DInt> center, Vector2DInt extent, out QuadPreCache cache)
        {
            if (center.Equals())
            {
                cache = default;
        ...
        #region 插入/删除元素
        public void InsertElement(int treeId, int index, Vector2DInt center, int extent)
        {
            var tree = _trees[treeId];
            var element = new QuadElement(index, new AABB2DInt(center, extent));
            tree.Insert(in element);
        }
        public void InsertElement(int treeId, int index, Vector2DInt center, Vector2DInt extent)
        {
            var tree = _trees[treeId];
            var element = new QuadElement(index, new AABB2DInt(center, extent));
            tree.Insert(in element);
        ...
        public bool RemoveElement(int treeId, int index, Vector2DInt center, int extent)
        {
            var tree = _trees[treeId];
            var element = new QuadElement(index, new AABB2DInt(center, extent));
        ...
        public bool RemoveElement(int treeId, int index, Vector2DInt center, Vector2DInt extent)
        {
            var tree = _trees[treeId];
            var element = new QuadElement(index, new AABB2DInt(center, extent));
            bool success = tree.Remove(in element);
        ...
        #region 更新元素
        public void UpdateElement(int treeId, int index, in Change<Vector2DInt> center, int extent)
        {
            if (center.Equals())
                return;
        ...
        public void UpdateElement(int treeId, int index, in Change<Vector2DInt> center, Vector2DInt extent)
        {
            if (center.Equals())
                return;
        ...
        public void UpdateElement(Change<int> treeId, int index, Vector2DInt center, int extent)
        {
            if (treeId.Equals())
                return;
        ...
        public void UpdateElement(Change<int> treeId, int index, Vector2DInt center, Vector2DInt extent)
        {
            if (treeId.Equals())
                return;
        ...
        public void UpdateElement(Change<int> treeId, int index, in Change<Vector2DInt> center, int extent)
        {
        ...
        public void UpdateElement(Change<int> treeId, int index, in Change<Vector2DInt> center, Vector2DInt extent)
        {
            if (treeId.Equals() && center.Equals())
                return;
        ...
        #region 查询圆形区域内的元素
        public void QueryCircle(int treeId, Vector2DInt center, int extent, ICollection<QuadElement> elements)
        {
            var tree = _trees[treeId];
            var aabb = new AABB2DInt(center, extent);
            tree.QueryCircle(in aabb, elements);
        }
        public void QueryCircle(int treeId, Vector2DInt center, Vector2DInt extent, ICollection<QuadElement> elements)
        {
            var tree = _trees[treeId];
            var aabb = new AABB2DInt(center, extent);
            tree.QueryCircle(in aabb, elements);
        ...
        public void QueryCircle(IReadOnlyList<int> treeIds, Vector2DInt center, int extent, ICollection<QuadElement> elements)
        {
            var aabb = new AABB2DInt(center, extent);
        ...
        public void QueryCircle(IReadOnlyList<int> treeIds, Vector2DInt center, Vector2DInt extent, ICollection<QuadElement> elements)
        {
            var aabb = new AABB2DInt(center, extent);
            for (int count = treeIds.Count, i = 0; i < count; ++i)
            {
        ...
        #region 查询无向矩阵区域内的元素
        public void QueryBox(int treeId, Vector2DInt center, int extent, ICollection<QuadElement> elements)
        {
            var tree = _trees[treeId];
            var aabb = new AABB2DInt(center, extent);
            tree.QueryBox(in aabb, elements);
        }
        public void QueryBox(int treeId, Vector2DInt center, Vector2DInt extent, ICollection<QuadElement> elements)
        {
            var tree = _trees[treeId];
            var aabb = new AABB2DInt(center, extent);
            tree.QueryBox(in aabb, elements);
        ...
        public void QueryBox(IReadOnlyList<int> treeIds, Vector2DInt center, int extent, ICollection<QuadElement> elements)
        {
            var aabb = new AABB2DInt(center, extent);
            for (int count = treeIds.Count, i = 0; i < count; ++i)
            {
        ...
        public void QueryBox(IReadOnlyList<int> treeIds, Vector2DInt center, Vector2DInt extent, ICollection<QuadElement> elements)
        {
            var aabb = new AABB2DInt(center, extent);
            for (int count = treeIds.Count, i = 0; i < count; ++i)
            {
        ...
        #region 查询有向矩形区域内的元素
        public void QueryRectangle(int treeId, Vector2DInt center, int extent, in Vector2D dir, ICollection<QuadElement> elements)
        {
            var tree = _trees[treeId];
            var aabb = new AABB2DInt(center, extent);
            tree.QueryRectangle(in aabb, in dir, elements);
        }
        public void QueryRectangle(int treeId, Vector2DInt center, Vector2DInt extent, in Vector2D dir, ICollection<QuadElement> elements)
        {
            var tree = _trees[treeId];
            var aabb = new AABB2DInt(center, extent);
            tree.QueryRectangle(in aabb, in dir, elements);
        ...
        public void QueryRectangle(IReadOnlyList<int> treeIds, Vector2DInt center, int extent, in Vector2D dir, ICollection<QuadElement> elements)
        {
            var aabb = new AABB2DInt(center, extent);
            for (int count = treeIds.Count, i = 0; i < count; ++i)
            {
        ...
        public void QueryRectangle(IReadOnlyList<int> treeIds, Vector2DInt center, Vector2DInt extent, in Vector2D dir, ICollection<QuadElement> elements)
        {
            var aabb = new AABB2DInt(center, extent);
            for (int count = treeIds.Count, i = 0; i < count; ++i)
            {
