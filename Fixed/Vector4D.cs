...
namespace Eevee.Fixed
{
    ...
    public struct Vector4D : IEquatable<Vector4D>, IComparable<Vector4D>, IFormattable
    {
        ...
        /// 返回副本，缩放模长
        /// </summary>
        public readonly Vector4D ScaleMagnitude(Fixed64 scale)
        {
            if (scale.RawValue == 0)
                return Zero;
        ...
        /// 返回该向量的模长为1的向量
        /// </summary>
        public readonly Vector4D Normalized() => this / Magnitude();
        /// <summary>
        /// 使该向量的模长为1
        /// </summary>
        ...
        /// 符号值
        /// </summary>
        public readonly Vector4D Sign() => new(X.Sign(), Y.Sign(), Z.Sign(), W.Sign());
        /// <summary>
        /// 绝对值
        /// </summary>
